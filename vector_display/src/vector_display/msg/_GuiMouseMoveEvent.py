...
"""autogenerated by genpy from vector_display/GuiMouseMoveEvent.msg. Do not edit."""
import codecs
import sys
...
class GuiMouseMoveEvent(genpy.Message):
  _md5sum = "53a26cd1bb23d1ed61768f55e50f7f84"
  _type = "vector_display/GuiMouseMoveEvent"
...
float32 y
float32 z"""
  __slots__ = ['header','location','buttons','modifiers']
  _slot_types = ['std_msgs/Header','geometry_msgs/Point32','uint32','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,location,buttons,modifiers
    ...
    """
    if args or kwds:
      super(GuiMouseMoveEvent, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_3f2I().pack(_x.location.x, _x.location.y, _x.location.z, _x.buttons, _x.modifiers))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.location.x, _x.location.y, _x.location.z, _x.buttons, _x.modifiers,) = _get_struct_3f2I().unpack(str[start:end])
      return self
