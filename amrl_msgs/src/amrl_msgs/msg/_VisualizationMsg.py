...
class VisualizationMsg(genpy.Message):
  _md5sum = "989408817adef9cc3922d1967821d49a"
...
float32 end_angle
uint32 color"""
  __slots__ = ['header','ns','particles','path_options','points','lines','arcs']
  _slot_types = ['std_msgs/Header','string','amrl_msgs/Pose2Df[]','amrl_msgs/PathVisualization[]','amrl_msgs/ColoredPoint2D[]','amrl_msgs/ColoredLine2D[]','amrl_msgs/ColoredArc2D[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,ns,particles,path_options,points,lines,arcs
